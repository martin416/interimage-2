 ...
 * JSON. 
 */
public class NLineJsonLoader extends LoadFunc implements LoadMetadata {
    ...
    public NLineJsonLoader() {
    }
    
    public NLineJsonLoader(String schemaString) throws IOException {
